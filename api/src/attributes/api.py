...
from . import people
from .models import Person, Account, AttriuteSchema, Enumerated_ValueSchema
from .. import db
...
def read_one_person_attribute(person_attribute_id):
    result = db.session.query(Person_Attribute).filter_by(id=person_attribute_id).first()
...
def update_person_attribute(person_attribute_id):
    ...
    person_attribute = db.session.query(Person_Attribute).filter_by(id=person_attribute_id).first()
