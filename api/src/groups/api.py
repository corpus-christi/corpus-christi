...
def read_one_manager_type(manager_type_id):
    ...
    if not manager_type:
        return log(jsonify(f"ManagerType with id #{manager_type_id} does not exist."), 404)
...
def read_one_manager(group_id, person_id):
    ...
    if manager is None:
        return log(jsonify(f"Manager with group_id #{group_id} and person_id #{person_id} does not exist"), 404)
...
def read_one_meeting(meeting_id):
    ...
    if meeting is None:
        return log(jsonify(f"Meeting with id {meeting_id} does not exist"), 404)
...
def read_one_member(group_id, person_id):
    ...
    if member is None:
        return log(jsonify(f"Member with group_id #{group_id} and person_id #{person_id} does not exist"), 404)
