...
Revision ID: 18dea6ea2536
Revises: 
Create Date: 2019-04-27 17:07:27.849817
...
def upgrade():
    ...
    op.create_table('auth_blacklist',
    ...
    sa.Column('type_i18n', sa.String(length=32), nullable=True),
    ...
    sa.Column('value_i18n', sa.String(length=32), nullable=True),
    sa.Column('active', sa.Boolean(), nullable=False),
    ...
    op.create_table('courses_course_completion',
    sa.Column('course_id', sa.Integer(), nullable=False),
    sa.Column('person_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['course_id'], ['courses_course.id'], ),
    sa.ForeignKeyConstraint(['person_id'], ['people_person.id'], ),
    sa.PrimaryKeyConstraint('course_id', 'person_id')
    )
    ...
    sa.ForeignKeyConstraint(['diploma_id'], ['courses_diploma.id'], ),
    sa.ForeignKeyConstraint(['person_id'], ['people_person.id'], ),
    sa.PrimaryKeyConstraint('person_id', 'diploma_id')
    )
