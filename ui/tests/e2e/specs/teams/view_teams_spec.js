function getAllTeamsOnPage(){
    ...
    cy.get(":nth-child(4) > .v-list__tile > .v-list__tile__content > .v-list__tile__title").click();
    cy.get(".md3 > .v-input > .v-input__control > .v-input__slot").click();
    cy.get(".menuable__content__active > .v-select-list > .v-list > :nth-child(3) > .v-list__tile > .v-list__tile__content").click();
}
