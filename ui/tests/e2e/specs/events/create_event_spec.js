describe("Create Event Test", function() {
  ...
  it("THEN: Error messages appear", function() {
    ...
    cy.get(
      "[name='location'] > .v-input > .v-input__control > .v-text-field__details > .v-messages > .v-messages__wrapper > .v-messages__message"
    ).should("exist");
    cy.get(
    ...
    cy.get(
      "[data-cy=end-date-menu] > .v-menu__activator > .v-input > .v-input__control > .v-text-field__details > .v-messages > .v-messages__wrapper > .v-messages__message"
    ).should("exist");
    cy.get(
      "[data-cy=end-time-dialog] > .v-dialog__activator > .v-input > .v-input__control > .v-text-field__details > .v-messages > .v-messages__wrapper > .v-messages__message"
    ).should("exist");
